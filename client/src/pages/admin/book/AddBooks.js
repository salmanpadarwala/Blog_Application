              ...
              <div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    name="bookDownload"
                    value={true}
                    checked={bookIsDownloadable === true}
                    onChange={handleRadioChange}
                    className="mr-2 appearance-none bg-white border border-gray-400 rounded-md checked:bg-blue-600 checked:border-transparent focus:outline-none focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                  />
                  <label
                  ...
                  <input
                    ...
                    name="bookDownload"
                    value={false}
                    checked={bookIsDownloadable === false}
                    onChange={handleRadioChange}
                    className="mr-2 appearance-none bg-white border border-gray-400 rounded-md checked:bg-blue-600 checked:border-transparent focus:outline-none focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                  />
                  <label
